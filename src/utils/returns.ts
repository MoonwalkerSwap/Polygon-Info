...
export const priceOverrides = [
  '0xC1cFb417F1D2059229eDE032b24A066d4761eB01', // USDC
  '0xDD0A2D544231B652e8C9c06831cDA2F4852D9D37', // DAI
]
...
function formatPricesForEarlyTimestamps(position): Position {
  if (position.timestamp < PRICE_DISCOVERY_START_TIMESTAMP) {
    ...
    // WETH price
    if (position.pair?.token0.id === '0xFf39cEee39cC81ddEa09aE55A08a6349c0A811EA') {
      position.token0PriceUSD = 203
    }
    if (position.pair?.token1.id === '0xFf39cEee39cC81ddEa09aE55A08a6349c0A811EA') {
